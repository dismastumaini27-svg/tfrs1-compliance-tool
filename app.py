...
# ---------- DEPARTMENT QUESTIONS (abbreviated for space) ----------
# (Keep your full DEPARTMENT_QUESTIONS and GLOBAL_QUESTIONS as previously)
...
# ---------- LOAD / SAVE FUNCTIONS (as before) ----------
# (Include the same load_data, create_new_data, save_data, load_synthesis, save_synthesis)
